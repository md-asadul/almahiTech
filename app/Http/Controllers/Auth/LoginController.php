...
class LoginController extends Controller
{
    ...
    */
    ...
    public function logout(Request $request)
    {
        ...
        createUserActivity($request, 'Logout', 'Logged out of the system', 'General', $user->name.'<'.$user->email.'>');
    ...
    public function blockedUserList(Request $request) {
        ...
        if($request->ajax()) {
            ...
            ->addColumn('action-btn', function($row) {
                $btn = '<a href="javascript:void(0)" id="deleteData" data-id="'.$row->email.'" data-original-title="Delete" class="btn btn-dt-delete">unlock</a>';
                return $btn;
            })
