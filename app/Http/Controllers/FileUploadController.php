...
class FileUploadController extends Controller
{
    ...
    public function upload(Request $request)
    {
        ...
        $image->save($filePath . $params['file_name'], (string) $image);
        $image_sm->save($filePath . $params['file_name_sm'], (string) $image_sm);
        $image_md->save($filePath . $params['file_name_md'], (string) $image_md);
